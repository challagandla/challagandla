...
`Snakemake` · `Python` · `R / Bioconductor` · `conda / mamba` · `STAR` · `DESeq2` · `MACS2` · `DiffBind` · `deepTools` · `MultiQC`

## 📊 GitHub activity

[![GitHub stats](https://github-readme-stats.vercel.app/api?username=challagandla&show_icons=true)](https://github.com/challagandla)
[![Top languages](https://github-readme-stats.vercel.app/api/top-langs/?username=challagandla&layout=compact)](https://github.com/challagandla)
